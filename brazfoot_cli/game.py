...
class BFGame:
    ...
    def extract_competition_header(self, soup):
        ...
        result['competition'], result['division'], result['edition'] = tuple(competition_name.split(' - '))
        result['game_number'] = int(competition_game_number)
    ...
    def extract_game_header(self, soup, date_mode):
        ...
        result['date_time'] = parse_datetime(game_header_date, game_header_time, mode=date_mode)
    ...
    def get_game_xml(self):
        ...
        edition = ET.SubElement(game, 'edition')
        edition.text = self.competition_header['edition']
        game_number = ET.SubElement(game, 'game_number')
        game_number.text = str(self.competition_header['game_number'])
        ...
        city.text = str(self.game_header['local']['city'])
        state = ET.SubElement(local, 'state')
        state.text = str(self.game_header['local']['state'])
        channel = ET.SubElement(local, 'channel')
        channel.text = str(self.game_header['local']['channel'])
        date_time = ET.SubElement(game, 'date_time')
        date_time.text = str(self.game_header['date_time'])
        ...
        hgoals.text = str(self.game_score['home']['goals'])
        ...
        agoals.text = str(self.game_score['away']['goals'])
    ...
    #-------------------------------------------------------------------------
    def __repr__(self):
        return r"game_" + str(self.competition_header['game_number'])